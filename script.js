...
function mostrar_tabla(objeto_estaciones){
  ...
  objeto_estaciones.forEach(objeto_estaciones =>{
    ...
    var porcentaje_bicis = "\t(" + (objeto_estaciones.num_bikes_available / num_total_docks * 100).toFixed(2) + " %)";
    var porcentaje_bicis_formato = objeto_estaciones.num_bikes_available + "/" + num_total_docks + "<span style='color:grey;'>" + porcentaje_bicis + "</span>"; //casera by otema666
    ...
    row.innerHTML = `
      ...
      <td>${porcentaje_bicis_formato}</td>
